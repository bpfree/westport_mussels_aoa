#############################################################
### 29. Industry, transportation, and navigation submodel ###
#############################################################
...
## Constraints
saveRDS(obj = hex_data, file = file.path(submodel_suitability_dir, stringr::str_glue("{region_name}_hex_{submodel}_{layer_name}_{date}.rds")))
